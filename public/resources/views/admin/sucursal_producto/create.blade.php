...
@section('header')
    Nuevo Traspaso Almacen - Sucursal
@endsection
...
@section('contenido')
            ...
            <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="precio_compra" id="precio_compra" disabled>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="pre1" id="pre1" required>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <label>Precio 2</label>
                                <input type="number" class="form-control" name="pre2" id="pre2" required>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <label>Precio 3</label>
                                <input type="number" class="form-control" name="pre3" id="pre3" required>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="agregar" class="btn btn-primary"><i class="icon-copy fa fa-cart-arrow-down"
                            aria-hidden="true"></i> Adicionar a sucursal</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <form method="post" action="{{ route('sucursal_producto.traspasar') }}">
        @csrf
        ...
        <div class="card-box mb-30">
            ...
            <div class="pd-20">
                <h4 class="text-blue h4">Listado de Productos a Traspasar</h4>
            </div>
            <div class="pb-20">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
                <a href="{{ route('sucursal_producto.index') }}"
                    class="btn btn-secondary waves-effect waves-light btncancelar">Cancelar</a>
            </div>
        </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('.btncancelar').click(function() {
                    alert('Traspaso a sucursal Cancelada !!!!');
                });
                ...
                $('#producto tbody').on('click', 'tr', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#pre1').val(response['pre1']);
                            $('#pre2').val(response['pre2']);
                            $('#pre3').val(response['pre3']);
            ...
            function agregar() {
                ...
                if (id_producto != "" && cantidad != "" && cantidad >= 0 && precio_compra != "" && produ.length > 4 &&
                    ...
                    var fila = '<tr class="selected" id="fila' + cont +
                        ...
                        '">' +
                        cantidad + ' </td> <td>' + pre1 + ' </td> <td>' + pre2 + ' </td><td>' + pre3 + ' </td></tr>';
                    cont++;
                    limpiar();
                    ...
                    alert("Debe de llenar  todos los campos, precios mayores  a 0  o cantidad debe ser menor igual a Stock");
                    /*  Swal.fire({
                               type: 'error',
                               title: 'Oops...',
            ...
            function evaluar() {
                if ($("#id_sucursal").val().length <= 10 && $('#detalles tr').length > 1) {
                    $("#guardar").show();
                } else {
                    $("#guardar").hide();
                }
