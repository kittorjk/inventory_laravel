...
@section('contenido')
    ...
    <div class="clearfix mb-20">
        <div class="pull-right">
            ...
            <a href="{{ route('traspaso.create') }}" class="btn btn-primary btn-sm scroll-click"><i
                    class="fa fa-plus"></i> Nueva Traspaso</a>
    ...
    <div class="modal fade bs-example-modal-lg" id="mdetalletraspaso" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">Detalle Traspaso de Producto</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
        ...
        $(document).ready(function() {
            ...
            $('#mdetalletraspaso').on('show.bs.modal', function(event) {
                ...
                $('#tDetalleTraspaso').DataTable({
                    ...
                    retrieve: true,
                    serverSide: true,
                    ajax: "api/detalle_traspaso/" + id, //url: "{{ route('search.productos') }}",
                    columns: [
                        //{data: 'id'},
                        {
                            data: 'foto',
