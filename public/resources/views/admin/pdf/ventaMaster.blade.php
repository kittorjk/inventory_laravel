...
<body>
    ...
    <div class="digital">
        ...
        <table width="100%" class="tabla3">
            <tr>
                ...
                <td align="center" class="fondo"><strong>TOTAL ING.</strong></td>
                <td align="center" class="fondo"><strong>P_COMPRA</strong></td>
                <td align="center" class="fondo"><strong>TOTAL CAP.</strong></td>
                <td align="center" class="fondo"><strong>TOTAL GAN.</strong></td>
            </tr>
            @foreach ($servicee as $ven)
                ...
                <tr>
                    ...
                    <td width="10%" align="center"><span class="text">{{ $ven->precio_venta }}</span></td>
                    <td width="10%" align="center"><span class="text">{{ $ven->cantidad }}</span></td>
                    <td width="10%" align="center"><span class="text">{{ $ven->subingreso }}</span></td>
                    <td width="10%" align="center"><span class="text">{{ $ven->precio_compra }}</span></td>
                    <td width="10%" align="center"><span class="text">{{ $ven->subcapital }}</span></td>
                    <td width="10%" align="center"><span class="text">{{ $ven->subganancia }}</span></td>
                    </tr>
    ...
    <tr>
     @foreach ($total as $t)
      <td colspan=10>
      <p class="poema">Total de Ingreso: {{number_format($t->tingreso,2)}}</p>
      <p class="poema">Total Capital: {{number_format($t->tcap,2)}}</p>
      <p class="poema">Total Ganacia: {{number_format($t->tgan,2)}}</p>
       @endforeach
      </td>
    </tr>
  </tfoot>
