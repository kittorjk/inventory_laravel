                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="pre1" id="pre1" required>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <label>Precio 2</label>
                                <input type="text" class="form-control" name="pre2" id="pre2" required>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <label>Precio 3</label>
                                <input type="text" class="form-control" name="pre3" id="pre3" required>
                            </div>
                        </div>
                    </div>
