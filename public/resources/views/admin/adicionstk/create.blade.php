...
@section('contenido')
    ...
    <form method="post" action="{{ route('sucursal_adicion.adicionstk') }}">
        @csrf
        ...
        <div class="card-box mb-30">
            ...
            <div class="pd-20">
                <h4 class="text-blue h4" id="lts1">Listado Productos a Adicionar Stock ... </h4>
            </div>
            <div class="pb-20">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
                <a href="{{ route('sucursal_adicion.index') }}"
            ...
            $(document).ready(function() {
                ...
                $('#tproductos tbody').on('click', 'tr', function() {
                    ...
                    if (data["stock"] >= 0) {
                        ...
                        $('#stock_p').text('Stock en Almacen: ' + data['stockal']);
                ...
                if (id_producto != "" && cantidad != "" && cantidad >= 0) {
                    if ((stk - cantidad) >= 0) {
                        var fila = '<tr class="selected" id="fila' + cont +
                            ...
                            precio_compra + '">' +
                            precio_compra + ' </td> <td><input type="hidden" name="cantidad[]" value="' +
